...
def inference(input, path):
    ...
    model = pmExperiment.load_from_checkpoint(path,config=config,vocab_size=len(vocab_dict)+1)
...
if __name__ == "__main__":
    ...
    for i in range(5):
        print(inference(input, "checkpoints/pm3/3itvyzer/checkpoints/epoch=79-step=174399.ckpt"))